        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Reserve your train tickets online, avoid the rush, and enjoy seamless travel across Incredible India.
            </motion.p>
            <motion.div
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="mt-4 text-4xl font-bold text-gray-900 md:text-5xl">
              Why Choose IndRailway?
            </h2>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
              We're committed to making your train travel experience in INDIA as
      ...
      <section ref={routesRef} className="scroll-mt-20 bg-white py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
              Discover India's most traveled train routes and top destinations.
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mb-10 max-w-2xl text-xl text-white/90">
              ...
              India's. Experience stunning landscapes and ancient wonders by
              rail.
            </p>
