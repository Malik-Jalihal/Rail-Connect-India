...
import { stations as localStations } from "../data/data";
...
export default function TrainSearchPage() {
  ...
  useEffect(() => {
    // Use fetched stations if available, otherwise fall back to local data
    if (stations && stations.length > 0) {
      setStationsList(stations);
    } else if (!isLoadingStations) {
      setStationsList(localStations);
    }
  ...
  function handleSearch(e) {
    e.preventDefault();
    if (!fromStation || !toStation || !stationsList) return;
