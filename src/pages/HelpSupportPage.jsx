...
const faqs = {
  general: [
    {
      id: "general-1",
      question: "What is India Railway?",
      answer:
        "India Railway is India's national railway booking platform, providing convenient online booking for train travel throughout India. Our service allows you to search for trains, book tickets, manage reservations, and access travel information all in one place.",
    },
    {
      id: "general-2",
      question: "How do I create an account?",
      answer:
        "To create an account, click on the 'Sign Up' button on the homepage. Fill in your personal details, create a password, and verify your email address. Once your account is created, you can login and access all features of IndRailway including booking tickets and managing your profile.",
    },
    {
      id: "general-3",
      question: "Is there a mobile app available?",
      answer:
        "Yes, IndRailway is available as a mobile app for both iOS and Android devices. You can download it from the App Store or Google Play Store to access all the features of our platform on your mobile device.",
    },
  ],
  booking: [
    {
  ...
  payment: [
    {
      ...
      answer:
        "We accept various payment methods including credit/debit cards (Visa, Mastercard, American Express), mobile wallets, direct bank transfers, and Fawry payments at authorized outlets throughout India.",
    },
    {
      id: "payment-2",
  ...
  travel: [
    {
      ...
      answer:
        "IndRailway offers several classes of service including First Class (air-conditioned with comfortable seating), Second Class (air-conditioned with standard seating), and Economy Class. We also operate special Express trains and Sleeper services on longer routes.",
    },
    {
      id: "travel-2",
  ...
  loyalty: [
    {
      ...
      answer:
        "Our loyalty program rewards frequent travelers with points for every journey. You earn 10 points per Indian rupee spent on tickets. These points can be redeemed for free tickets, upgrades, or other rewards through your account.",
    },
    {
      id: "loyalty-2",
            ...
            <div className="mx-auto max-w-4xl">
              <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-3">
                ...
                <div className="rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 p-6 text-center text-white shadow-lg">
                  ...
                  <p className="mb-1 text-lg">support@Indrailway.eg</p>
                  <p className="text-sm text-white/80">
